        ...
        <div>
            <section className=''>
                <div className='container px-5 py-10 mx-auto'>
                    <h1 className=' text-center text-3xl font-bold text-black' style={{
                        color: mode === 'dark' ? 'white' : ''
                    }}>Testimonial</h1>
                    <h2 className=' text-center text-2xl font-semibold mb-10' style={{
                        color:
                            mode === 'dark' ? 'white' : ''
                    }}>What our <span className='
                     text-pink-500'>customers</span> are saying</h2>
                    ...
                    <div className='flex flex-wrap -m-4'>
                        <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                            <div className="h-full text-center">
                                ...
                                <h2 style={{ color: mode === 'dark' ? '#ff4162' : '' }} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">Siba Prasad Sahoo</h2>
                                <p style={{ color: mode === 'dark' ? 'white' : '' }} className="text-gray-500">Junior Frontend Developer</p>
                            </div>
